...
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your puffscoin private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new puffscoin network down to  |")
	...
	log.Info("Administering puffscoin network", "name", w.network)
