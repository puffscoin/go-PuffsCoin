...
import (
	...
	"github.com/puffscoin/go-puffscoin/signer/core"
	"github.com/puffscoin/go-puffscoin/signer/fourbyte"
	"github.com/puffscoin/go-puffscoin/signer/rules"
	"github.com/puffscoin/go-puffscoin/signer/storage"
...
func init() {
	app.Name = "Clef"
	app.Usage = "Manage puffscoin account operations"
	app.Flags = []cli.Flag{
		logLevelFlag,
		keystoreFlag,
		configdirFlag,
