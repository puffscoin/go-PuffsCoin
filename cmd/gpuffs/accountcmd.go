...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage puffscoin wallets",
		ArgsUsage: "",
...
between puffscoin nodes by simply copying.
