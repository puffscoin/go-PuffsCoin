...
import (
	...
	"github.com/puffscoin/go-puffscoin/p2p/discover"
...
func main() {
	var (
		listenAddr  = flag.String("addr", ":31313", "listen address")
	...
	if natm != nil {
		if !realaddr.IP.IsLoopback() {
			go nat.Map(natm, nil, "udp", realaddr.Port, realaddr.Port, "puffscoin discovery")
		}
