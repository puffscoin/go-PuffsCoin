## Go puffscoin Dashboard

The dashboard is a data visualizer integrated into gpuffs, intended to collect and visualize useful information of an puffscoin node. It consists of two parts:
...
```
$ gpuffs --dashboard --vmodule=dashboard=5
