...
// Service implements an Puffscoin netstats reporting daemon that pushes local
// chain statistics up to a monitoring server.
type Service struct {
	server *p2p.Server        // Peer-to-peer server to retrieve networking infos
	eth    *eth.Puffscoin     // Full Puffscoin service if monitoring a full node
	les    *les.LightEthereum // Light Puffscoin service if monitoring a light node
...
func New(url string, ethServ *eth.Puffscoin, lesServ *les.LightEthereum) (*Service, error) {
