...
// Package filters implements an puffscoin filtering system for block,
...
type subscription struct {
	...
	typ       Type
	created   time.Time
	logsCrit  puffscoin.FilterQuery
	logs      chan []*types.Log
...
func (es *EventSystem) SubscribeLogs(crit puffscoin.FilterQuery, logs chan []*types.Log) (*Subscription, error) {
...
func (es *EventSystem) subscribeMinedPendingLogs(crit puffscoin.FilterQuery, logs chan []*types.Log) *Subscription {
	sub := &subscription{
		id:        rpc.NewID(),
...
func (es *EventSystem) subscribeLogs(crit puffscoin.FilterQuery, logs chan []*types.Log) *Subscription {
	sub := &subscription{
		id:        rpc.NewID(),
...
func (es *EventSystem) subscribePendingLogs(crit puffscoin.FilterQuery, logs chan []*types.Log) *Subscription {
	sub := &subscription{
		id:        rpc.NewID(),
