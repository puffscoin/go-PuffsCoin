...
import (
	...
	"github.com/puffscoin/go-puffscoin/internal/jsre"
	"github.com/puffscoin/go-puffscoin/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client  // RPC client to execute puffscoin requests through
...
func (c *Console) Welcome() {
	message := "Welcome to the gPuffs JavaScript console!\n\n"
