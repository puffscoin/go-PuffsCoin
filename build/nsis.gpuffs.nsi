...
# 1. install gpuffs for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gpuffs
# 5. create gpuffs, attach and uninstall start menu entries
...
!define GROUPNAME "PUFFScoin"
!define APPNAME "gpuffs"
!define DESCRIPTION "Official Go implementation of the PUFFScoin protocol"
!addplugindir .\
