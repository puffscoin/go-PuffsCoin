...
!define HELPURL "https://github.com/puffscoin/go-puffscoin/issues"
!define UPDATEURL "https://github.com/puffscoin/go-puffscoin/releases"
!define ABOUTURL "https://github.com/puffscoin/go-puffscoin#puffscoin-go"
...
Section "Geth" GETH_IDX
  ...
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gpuffs.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gpuffs.exe" "attach" "" ""
  ...
  # Firewall - add rules
  SimpleFC::AdvAddRule "gpuffs incoming peers (TCP:31313)" ""  6 1 1 2147483647 1 "$INSTDIR\gpuffs.exe" "" "" "PUFFScoin" 31313 "" "" ""
  SimpleFC::AdvAddRule "gpuffs outgoing peers (TCP:31313)" ""  6 2 1 2147483647 1 "$INSTDIR\gpuffs.exe" "" "" "PUFFScoin" "" 31313 "" ""
  SimpleFC::AdvAddRule "gpuffs UDP discovery (UDP:31313)" "" 17 2 1 2147483647 1 "$INSTDIR\gpuffs.exe" "" "" "PUFFScoin" "" 31313 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\gpuffs.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\gpuffs.ipc"
